...
$(function () {
    ...
    //header>h2 animation
    $("header>h2").html("_");
    var headerh2 = "Be ready to be <strong>Owned</strong>";
    var i = 0;
    ...
    $(window).scroll(function () {
        if ($("article:nth-of-type(2) #chatter_teeth_vr").is(':in-viewport') && !modalVRAnimated) {
            ...
            var modalInterval = setInterval(function () {
                ...
                $("<div title='question'><p> u want to be destroyed by karnaux??</p></div>").dialog({
    ...
    $("#download").click(function(){    
        $("").dialog({
                        ...
                        buttons: {
                            "YES": function () {
                                window.open("https://vk.com/m4dstubs","_blank");
                                $(this).dialog("destroy");
                            },
                        },
                        close: function (event, ui) {
